...
fun main(args: Array<String>) {
    GeneratorCodeUtils().execute(listOf("t_interact_blacklist"))
}
...
class GeneratorCodeUtils {
    ...
    companion object {
        ...
        const val MODULE_NAME = "live-common-beta"

        const val DATASOURCE_URL = "jdbc:mysql://sr-test-mysql-master-1.gz.cvte.cn:3306/seewo_live_server?characterEncoding=UTF-8&rewriteBatchedStatements=true&useSSL=false&allowMultiQueries=true&serverTimezone=Asia/Shanghai"

        const val DATA_USER_NAME = "seewo"

        const val DATA_PASSWORD = "seewo@cvte"
